...
public class PromotionActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    protected void parseJsonLogic(PromotionResponseBean promotionResponse, String response, boolean isInternetAvailable) {
        ...
        if (promotionResponse.getBanner_type() == 1) {
            ...
            CustomPagerAdapter pagerAdapter = new CustomPagerAdapter(mContext, urls);
            ...
            if (urls.length >= 1) {
                ...
                switch (urls.length) {
                    ...
                    case 3:
                        dotOne.setVisibility(View.VISIBLE);
                        dotTwo.setVisibility(View.VISIBLE);
                        dotThree.setVisibility(View.VISIBLE);
                        break;
                    case 4:
                        dotOne.setVisibility(View.VISIBLE);
                        dotTwo.setVisibility(View.VISIBLE);
                        dotThree.setVisibility(View.VISIBLE);
                        dotFour.setVisibility(View.VISIBLE);
                        break;
                    case 5:
                        dotOne.setVisibility(View.VISIBLE);
                        dotTwo.setVisibility(View.VISIBLE);
                        dotThree.setVisibility(View.VISIBLE);
                        dotFour.setVisibility(View.VISIBLE);
                        dotFive.setVisibility(View.VISIBLE);
                        break;
                }

                dotOne.setBackgroundResource(R.drawable.gray_circle);
                dotTwo.setBackgroundResource(R.drawable.red_circle);
                dotThree.setBackgroundResource(R.drawable.red_circle);
                dotFour.setBackgroundResource(R.drawable.red_circle);
                ...
                promotionViewPager.addOnPageChangeListener(new OnPageChangeListener() {
                    ...
                    public void onPageSelected(int position) {
                        ...
                        switch (position) {
                            ...
                            case 1:
                                dotOne.setBackgroundResource(R.drawable.red_circle);
                                dotTwo.setBackgroundResource(R.drawable.gray_circle);
                                dotThree.setBackgroundResource(R.drawable.red_circle);
                                dotFour.setBackgroundResource(R.drawable.red_circle);
                                dotFive.setBackgroundResource(R.drawable.red_circle);
                                break;
                            ...
                            case 2:
                                dotOne.setBackgroundResource(R.drawable.red_circle);
                                dotTwo.setBackgroundResource(R.drawable.red_circle);
                                dotThree.setBackgroundResource(R.drawable.gray_circle);
                                dotFour.setBackgroundResource(R.drawable.red_circle);
                                dotFive.setBackgroundResource(R.drawable.red_circle);
                                break;
                            ...
                            case 3:
                                ...
                                dotTwo.setBackgroundResource(R.drawable.red_circle);
                                dotThree.setBackgroundResource(R.drawable.red_circle);
                                dotFour.setBackgroundResource(R.drawable.gray_circle);
                                dotFive.setBackgroundResource(R.drawable.red_circle);
                                break;
                            ...
                            case 4:
                                ...
                                dotThree.setBackgroundResource(R.drawable.red_circle);
                                dotFour.setBackgroundResource(R.drawable.red_circle);
                                dotFive.setBackgroundResource(R.drawable.gray_circle);
                                break;
        ...
        } else if (promotionResponse.getBanner_type() == 2) {
//			BannerListBean[] bannerList = promotionResponse.getBannerList();
//			youTubeVideoURL = bannerList[0].getBanner_url();
//			youTubeView = (YouTubePlayerView) findViewById(R.id.promotion_youtube_view);
//			youTubeView.initialize(Constants.DEVELOPER_KEY, PromotionActivity.this);
...
//			runThread();
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer player, boolean wasRestored) {
        ...
        if (!wasRestored) {
            String youTubeID = Utils.getYouTubeId(youTubeVideoURL);
